...
> Åbn denne side på [https://solveig-byg.github.io/start/](https://solveig-byg.github.io/start/)
...
* søg efter **https://github.com/solveig-byg/start**, og importer

## Rediger dette projekt ![Byggestatus-badge](https://github.com/solveig-byg/start/workflows/MakeCode/badge.svg)

Sådan redigerer du dette lager i MakeCode.

* åbn [https://makecode.microbit.org/](https://makecode.microbit.org/)
* klik på **Importer**, og klik derefter på **Import-URL-adresse**
* indsæt **https://github.com/solveig-byg/start**, og klik på Importer
...
![En genereret visning af blokkene](https://github.com/solveig-byg/start/raw/master/.github/makecode/blocks.png)
